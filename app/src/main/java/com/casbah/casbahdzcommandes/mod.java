...
public class mod extends AppCompatActivity {
    ...
    private int id_commande=0,year,dayOfMonth,month;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (extras.containsKey("date")) {
            ...
            try {
                idd.setText(format2.format(format1.parse(id)));
        ...
        D.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            public void onFocusChange(View v, boolean hasFocus) {
                if(hasFocus) {
                    DatePickerDialog datePickerDialog = new DatePickerDialog(mod.this,R.style.DialogTheme,
                            new DatePickerDialog.OnDateSetListener() {
                                @Override
                                public void onDateSet(DatePicker datePicker, int yearr, int monthh, int dayy) {

                                    String d=convertDate(dayy)+"-"+convertDate(monthh+1)+"-"+yearr;
                                    D.setText(d+"");
                                    year= yearr;
                                    month=monthh;
                                    dayOfMonth=dayy;
...
h();
    ...
    private void launchCamera() {
        ...
        if (photoFile != null) {
            Uri photoURI = FileProvider.getUriForFile(mod.this,
...
//If the permission has been granted...//
        if (EasyPermissions.hasPermissions(mod.this, Manifest.permission.CAMERA)) {
            super.onRequestPermissionsResult(requestCode, permissions, grantResults);
            EasyPermissions.onRequestPermissionsResult(requestCode, permissions, grantResults, mod.this);
            launchCamera();
...
//If the user denies the permission request, then display a toast with some more information//
            ...
            Toast.makeText(mod.this, "Please enable location services to allow GPS tracking", Toast.LENGTH_SHORT).show();
        }}
    }
    ...
    public void h(){
        ...
        H.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            public void onFocusChange(View v, boolean hasFocus) {
                if(hasFocus) {
                    TimePickerDialog mTimePicker = new TimePickerDialog(mod.this, new TimePickerDialog.OnTimeSetListener() {
                        @Override
    ...
    public void envoyer(){
        ...
        if(!idd.getText().toString().equals("") && iddd.size()!=0)
        {
            ...
            AndroidNetworking.post(DATA_INSERT_URL)
                    ...
                    .getAsJSONArray(new JSONArrayRequestListener() {
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            if(response != null)
                                try{
                                    ...
                                    e.printStackTrace();
                                    Toast.makeText(mod.this, "Mail n'existe pas", Toast.LENGTH_SHORT).show();
                                }
                        ...
                        public void onError(ANError anError) {
                            progress.dismiss();
                            fab.setClickable(true);
                            Toast.makeText(mod.this, "Erreur de connexion", Toast.LENGTH_SHORT).show();
                        }
            ...
            Toast.makeText(mod.this, "Ajoutez des produits SVP", Toast.LENGTH_SHORT).show();
            progress.dismiss();
            fab.setClickable(true);
                               ...
                               /* bd= new BDD(getActivity());
                                ...
                                bd.close();*/
                                    ...
                                    if(x==idd.size()-1){
                                        progress.dismiss();
                                        fab.setClickable(true);
                                        Toast.makeText(mod.this, "Votre commande est modifiée ! Merci de nous avoir fait confiance", Toast.LENGTH_SHORT).show();
