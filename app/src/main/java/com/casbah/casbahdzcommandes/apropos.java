...
public class apropos extends AppCompatActivity {
    ...
    private void launchCamera() {
        ...
        if (photoFile != null) {
            Uri photoURI = FileProvider.getUriForFile(apropos.this,
...
//If the permission has been granted...//
        if (EasyPermissions.hasPermissions(apropos.this, Manifest.permission.CAMERA)) {
            super.onRequestPermissionsResult(requestCode, permissions, grantResults);
            EasyPermissions.onRequestPermissionsResult(requestCode, permissions, grantResults, apropos.this);
            launchCamera();
...
//If the user denies the permission request, then display a toast with some more information//
            ...
            Toast.makeText(apropos.this, "Please enable location services to allow GPS tracking", Toast.LENGTH_SHORT).show();
        }}
    }
    ...
    public void h(){
        ...
        H.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            public void onFocusChange(View v, boolean hasFocus) {
                if(hasFocus) {
                    TimePickerDialog mTimePicker = new TimePickerDialog(apropos.this, new TimePickerDialog.OnTimeSetListener() {
                        @Override
...
{
    Toast.makeText(apropos.this, "Remplissez tous les champs SVP", Toast.LENGTH_SHORT).show();
    progress.dismiss();
    fab.setClickable(true);

}
else if(!mdpc.equals(mdp)){
    Toast.makeText(apropos.this, "Le mot de passe confirmé n'est pas juste", Toast.LENGTH_SHORT).show();
    progress.dismiss();
    fab.setClickable(true);
}
            ...
            AndroidNetworking.post(DATA_INSERT_URL)
                    ...
                    .getAsJSONArray(new JSONArrayRequestListener() {
                            ...
                            if(response != null)
                                try{
                                   ...
                                   if(response.get(0).toString().equals("Success")){
                                       ...
                                       bd.close();
                                       Intent myIntent = new Intent(apropos.this, MainActivity.class);
                                       ...
                                       Toast.makeText(apropos.this, "Changer l'email où le nom", Toast.LENGTH_SHORT).show();
                                    ...
                                    fab.setClickable(true);
                                    e.printStackTrace();
                                    Toast.makeText(apropos.this, "Mail n'existe pas", Toast.LENGTH_SHORT).show();
                                }
                        ...
                        public void onError(ANError anError) {
                            progress.dismiss();
                            fab.setClickable(true);
                            Toast.makeText(apropos.this, "Erreur de connexion", Toast.LENGTH_SHORT).show();
                        }
